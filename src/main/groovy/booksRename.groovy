...
def publishers = 'Addison.Wesley Apress Big.Nerd FT.Press IBM.Press No.Starch.Press No.Starch Oreilly Packtpub Pragmatic Prentice.Hall Prentice.Hall QUE Sams Wiley'.tokenize()
